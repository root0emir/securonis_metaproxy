...
var testConfig bool
var debug bool
var proxyAddr string // Proxy adresi için yeni bir değişken
var LogWriter *syslog.Writer
var SyslogError error

func init() {
	LogWriter, SyslogError = syslog.New(syslog.LOG_DEBUG, "securonis-metaproxy")
	if SyslogError != nil {
	...
	flag.StringVar(&proxyAddr, "proxy", "127.0.0.1:9050", "proxy address for DNS resolution") // Proxy adresi
}
